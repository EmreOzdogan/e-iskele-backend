...
namespace EIskele.Persistence.Migrations
{
    ...
    public partial class AddDecimalPrecisions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payouts_CaptainId_Status",
                table: "Payouts",
                columns: new[] { "CaptainId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Payouts_PayoutNo",
                table: "Payouts",
                column: "PayoutNo",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlots_BoatId_StartDateTime_EndDateTime",
                table: "AvailabilitySlots",
                columns: new[] { "BoatId", "StartDateTime", "EndDateTime" });

            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlots_BoatId1",
                table: "AvailabilitySlots",
                column: "BoatId1");

            migrationBuilder.AddForeignKey(
                name: "FK_AvailabilitySlots_Boats_BoatId1",
                table: "AvailabilitySlots",
                column: "BoatId1",
